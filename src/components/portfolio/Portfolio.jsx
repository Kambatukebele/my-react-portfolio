...
const Portfolio = () => {
  return (
    <>
        <section className="w-full h-fit py-10 relative" id="portfolio">
            <div className="w-[90%] mx-auto sm:w-[600px] md:w-[700px] lg:w-[990px]">
                ...
                <div className="w-[286px] mx-auto flex flex-col justify-center items-center sm:flex-row">
                    <button className="block bg-gradient-to-r from-sky-500 to-indigo-500 hover:bg-gradient-to-l text-white text-base w-48 py-3 rounded-md font-normal transition delay-150 duration-300 ease-in-out sm:mr-2 lg:py-3 mb-2 sm:mb-0">
                        Back-End
                    </button>
                    ...
                    {/* Card */}
                    {
                        portfolios.map((portfolio) => (
                            ...
                            <div className="h-[370px] w-full">
                                ...
                                <span className="shadow-lg border bg-white w-36 mr-1 text-center rounded-md py-1">{portfolio.stack[0]}</span>
                                <span className="shadow-lg border bg-white w-36 text-center rounded-md py-1">{portfolio.stack[1]}</span>
                                </div>
